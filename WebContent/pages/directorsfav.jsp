...
<body>
<c:set var="label" value="Who is the director's favorite?"/>
<c:set var="thisPage" value="directorsfav.jsp"/>
<c:set var="placeholder" value="Enter director's name..."/>
<c:set var="queryType" value="directorsFav"/>
