...
<body>
<c:set var="label" value="Search for Top Movies"/>
<c:set var="thisPage" value="topmovies.jsp"/>
<c:set var="placeholder" value="Search for how many?"/>
<c:set var="queryType" value="topMovies"/>
