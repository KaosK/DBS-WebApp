...
<body>
<c:set var="label" value="Search for Movies"/>
<c:set var="thisPage" value="searchmovies.jsp"/>
<c:set var="placeholder" value="Enter Title..."/>
<c:set var="queryType" value="searchMovies"/>
